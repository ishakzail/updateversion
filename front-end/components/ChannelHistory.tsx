    ...
    return(
        ...
        <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
            <li><button className="flex">
                <Image className="w-10 h-10 rounded-full border-4 border-green-600" src={defaul} alt="df" />
                <p>mohamed haddaoui</p>
                </button></li>
                <li><button className="flex">
                <Image className="w-10 h-10 rounded-full border-4 border-red-600" src={defaul} alt="df" />
                <p>mohamed haddaoui</p>
                </button></li>
                <li><button className="flex">
                <Image className="w-10 h-10 rounded-full border-4 border-green-600" src={defaul} alt="df" />
